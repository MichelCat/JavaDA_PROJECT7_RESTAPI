...
/**
 * CurveController is the Endpoint will perform the following actions via Get/Post/Put/Delete with HTTP on CurvePoint.
 *
 * @author MC
 * @version 1.0
 */
...
public class CurveController {
    ...
    public String home(Model model)
    {
        ...
        model.addAttribute("curvePoints", curveBusiness.getCurvePointsList());
    ...
    public String validate(@Valid CurvePoint curvePoint
        ...
        try {
            // Save CurvePoint
            CurvePoint curvePointSave = curveBusiness.createCurvePoint(curvePoint);
    ...
    public String showUpdateForm(@PathVariable("id") Integer id
        ...
        try {
            CurvePoint curvePoint = curveBusiness.getCurvePointById(id);
    ...
    public String updateCurvePoint(@PathVariable("id") Integer id
        ...
        try {
            // Modify CurvePoint
            CurvePoint curvePointSave = curveBusiness.updateCurvePoint(id, curvePoint);
    ...
    public String deleteCurvePoint(@PathVariable("id") Integer id
        ...
        try {
            // Delete CurvePoint
            curveBusiness.deleteCurvePoint(id);
